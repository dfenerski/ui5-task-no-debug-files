...
/**
 * Initialization Code and shared classes of library com.github.dfenerski.library.
 */
...
const thisLib: { [key: string]: unknown } = Lib.init({
	...
	types: ["com.github.dfenerski.library.ExampleColor"],
	interfaces: [],
	controls: ["com.github.dfenerski.library.Example"],
	elements: [],
